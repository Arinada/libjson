...
class Spectrum
{
    ...
    public function wavelength2RGB($length)
    {        //Функция генерирования RGB цвета по длине волны
    ...
    {        //Функция компресси линий (соседние линии с определённой точностью сжимаются в одну)
    ...
    public function getSpectraSVG($transitions, $min, $max)
    {        //функция из массива переходов генерирует массив вида [длина волны:цвет] в формате JSON
        $x = 0;
        $obj = "{";
